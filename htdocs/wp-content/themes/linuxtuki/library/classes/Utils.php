...
class Utils {
	...
	public function get_default_image( $size = 'full' ) {
		$image_id = isset( get_option( 'linux_tuki_general_options' )['linux_tuki_default_image_id'] ) ? get_option( 'linux_tuki_general_options' )['linux_tuki_default_image_id'] : null;
